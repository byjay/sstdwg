...
from routes.project_permission import project_permission_bp
from routes.password import password_bp
from routes.drawing import drawing_bp
from routes.enhanced_file_management import enhanced_file_bp
from routes.simplified_user_management import simplified_user_bp
from routes.local_file_storage import local_storage_bp
from routes.secure_auth import secure_auth_bp
from routes.manual import manual_bp
from routes.notification_api import notification_bp
...
app.register_blueprint(enhanced_file_bp, url_prefix='/api')
app.register_blueprint(simplified_user_bp, url_prefix='/api')
app.register_blueprint(local_storage_bp, url_prefix='/api')
app.register_blueprint(secure_auth_bp, url_prefix='/api')
...
def health_check():
    ...
    return {
        ...
        'version': '1.0.0',
        'system': 'Ship Design Document Management System'
    }
